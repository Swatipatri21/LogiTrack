    ...
    public void sendTaskAssignedEmail(User staff,
        ...
        String attemptNote = attempt > 1
                ? "<div style='background:#FFEBEE;" +
                  ...
                  "⚠️ Reassigned Task (Attempt #" + attempt +
                  ")</strong><br>" +
                  "<span style='color:#37474F;font-size:13px;'>" +
                  "Previous staff did not complete on time." +
                  "</span></div>"
                : "";
...
//    }
    ...
    public void sendStatusUpdateEmail(Shipment shipment,
                                      ...
                                      String remarks,
                                      String location) {
        String subject = getSubjectForStatus(
                newStatus, shipment.getTrackingId());
    ...
    public void sendDelayNotificationEmail(Shipment shipment,
        ...
        String body = """
            <div style="font-family:Arial,sans-serif;
                ...
                <p style="color:#37474F;">
                    Dear <strong>%s</strong>,
                    we regret to inform you that your shipment
                    has been delayed.
                </p>
                <table style="width:100%%;
                              border-collapse:collapse;
                ...
                <p style="color:#37474F;">
                    ...
                    Our team is working to deliver your package
                    as soon as possible.
                </p>
            </div>
            """.formatted(
...
//                subject, body);
    ...
    @Async
    @Transactional
    public void sendShipmentDeletedEmail(Shipment shipment,
                                         String adminEmail) {
...
//        sendEmail(adminEmail, subject, body);
    ...
    // ── HELPER METHODS ────────────────────────────────────────
    private String getSubjectForStatus(ShipmentStatus status,
                                       String trackingId) {
        return switch (status) {
            case DISPATCHED ->
                    "Your Shipment is Dispatched 🚚 — "
                    + trackingId;
            case IN_TRANSIT ->
                    "Your Shipment is In Transit 🛣️ — "
                    + trackingId;
    ...
    private String getExtraMessageForStatus(
